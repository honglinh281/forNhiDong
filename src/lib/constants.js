...
export const ROW_STATUS = {
  ...
  DUPLICATE_HSCODE: 'DUPLICATE_HSCODE',
...
export const STATUS_LABELS = {
  ...
  [ROW_STATUS.DUPLICATE_HSCODE]: 'Trùng HS code',
  [ROW_STATUS.PARSE_ERROR]: 'Lỗi đọc dữ liệu'
};

export const STATUS_PRIORITY = {
  [ROW_STATUS.PARSE_ERROR]: 0,
  [ROW_STATUS.DUPLICATE_HSCODE]: 1,
  [ROW_STATUS.MISMATCH]: 2,
  [ROW_STATUS.MISSING_IN_EXCEL]: 3,
  [ROW_STATUS.MISSING_IN_PDF]: 4,
  [ROW_STATUS.MATCH]: 5
};
...
export const STATUS_FILTERS = [
  ...
  { value: ROW_STATUS.DUPLICATE_HSCODE, label: STATUS_LABELS[ROW_STATUS.DUPLICATE_HSCODE] },
